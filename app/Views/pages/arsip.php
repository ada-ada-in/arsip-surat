...
<?= view('components/modals/arsip/edit-modal') ?>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    <a  class="dropdown-item" href="/admin/disposisi/isidisposisi?id=${item.id}" target="_blank" >
                                        <i class="micon bi bi-textarea-resize"></i> Disposisi
                                    </a>
                                    <a  class="dropdown-item" href="/admin/disposisi/print?id=${item.id}" target="_blank" >
