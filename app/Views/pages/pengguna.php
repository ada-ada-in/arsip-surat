...
<?= view('components/modals/pengguna/add-pengguna-modal') ?>
<?= view('components/modals/pengguna/edit-pengguna-modal') ?>
...
<script>
    $(function () {
        ...
        $('#form-add-pengguna').on('submit', function (e) {
            ...
            const formData = {
                ...
                handphone: $(form).find('input[name="handphone"]').val(),
        ...
        $(document).on('click', '.btn-edit-pengguna', function () {
            ...
            $('#editpenggunamodal input[name="name"]').val(button.data('name'));
            $('#editpenggunamodal input[name="email"]').val(button.data('email'));
            $('#editpenggunamodal input[name="handphone"]').val(button.data('handphone'));
            $('#editpenggunamodal select[name="role"]').val(button.data('role'));
            $('#editpenggunamodal select[name="is_active"]').val(button.data('isactive'));
        });
    ...
    $('#searchinput').on('input', function () {
        ...
        const filtered = filteredData.filter(item =>
            ...
            item.handphone.toLowerCase().includes(keyword) ||
