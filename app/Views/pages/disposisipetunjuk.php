...
<?= view('components/modals/disposisi-petunjuk/add-modal') ?>
<?= view('components/modals/disposisi-petunjuk/edit-modal') ?>
...
<script>
    $(function () {
            ...
            paginatedItems.forEach((item, i) => {
                row += `
                    <tr>
                        ...
                        <td>${item.nama_disposisi_petunjuk}</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    <button type="button" class="dropdown-item btn-edit" data-toggle="modal" data-target="#editmodal"
                                        data-id="${item.id}"
                                        data-name="${item.nama_disposisi_petunjuk}">
        ...
        $('#form-add').on('submit', function (e) {
            ...
            const form = this;
            const formData = {
                nama_disposisi_petunjuk: $(form).find('input[name="nama_disposisi_petunjuk"]').val()
            };
        ...
        $(document).on('click', '.btn-delete', function () {
            ...
            if (confirm('Apakah kamu yakin ingin menghapus disposisi petunjuk ini?')) {
                $.ajax({
                    url: `/api/v1/disposisi-petunjuk/${id}`,
                    type: 'DELETE',
                    success: function () {
        ...
        $(document).on('click', '.btn-edit', function () {
            ...
            $('#editmodal input[name="nama_disposisi_petunjuk"]').val(button.data('name'));
        });
    ...
    $('#searchinput').on('input', function () {
        ...
        const filtered = filteredData.filter(item =>
            item.nama_disposisi_petunjuk.toLowerCase().includes(keyword)
        );
