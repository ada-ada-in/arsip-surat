    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title fs-5" id="staticBackdropLabel">Tambah Surat Keluar</h1>
            ...
            <div class="modal-body">
                <div class="basic-form">
                    <form id="form-add">
                        <div class="row">
                            <input type="text" class="form-control" hidden id="id_user" name="id_user" placeholder="Pengirim" required>
